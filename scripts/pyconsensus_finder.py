...
defaults = {
            'File_Name' : "None",
            'Email' : "None",
            'Maximum_Sequences' : "10000",
            'Blast_E_Value' : "0.1",
            'Consensus_Threshold' : "0.05",#need to check if zero will give desired results. Might need to be 1
            'Consensus_Ratio' : "1",
            'Use_Complete_sequences' : "False",
            'Alignment_Iterations' : "1",
            'Maximum_Redundancy_Threshold' : "0.7",
            'Logging' : "False",
...
if args.PDB and args.FILENAME is not None:
    message = 'Entered both a PDB code and a file name. Using the PDB .fasta file.'
    print (message)
